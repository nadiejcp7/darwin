...
export default function BodyAbout() {
    ...
    const informarLinks = ["./public/story.jpeg", "./public/focus.jpeg", "./public/wedo.jpeg"]
    ...
    return (
        <>
            ...
            <Contenedor imsg="./public/mission.jpeg" title="Our Mission"
                ...
                imageFirst={true} />
            <Contenedor imsg="./public/vision.jpeg" title='Our Vision'
